...
export default function Header({ onOpenSaved, onCopy, onSave }: HeaderProps) {
  return (
    <header className="flex flex-wrap min-h-[84px] items-center justify-between gap-4 border-b border-white/10 bg-white/8 px-4 py-3 md:px-7">
